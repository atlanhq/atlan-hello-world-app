...
suppressible: true
---
# Preserve Hello World metadata identity

- For changes that can affect Hello World-specific asset identity or hierarchy,
...
- Do not report when the diff cannot affect Hello World-specific identity or
  hierarchy.
